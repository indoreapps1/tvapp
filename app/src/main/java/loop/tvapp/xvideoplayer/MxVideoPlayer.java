package loop.tvapp.xvideoplayer;
...
import static loop.tvapp.xvideoplayer.MxUtils.scanForActivity;
...
//    public static final int SCREEN_WINDOW_TINY = 3;
    ...
    public static int FULLSCREEN_ORIENTATION = ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE; //由物理感应器决定显示方向
    ...
    public void onScrollChange() {
        ...
        if (mPlayUrl.equals(MxMediaManager.getInstance().getPlayer().getDataSource())) {
            ...
            if (currentListener.getScreenType() == SCREEN_WINDOW_FULLSCREEN) {
                if (isShown()) {
